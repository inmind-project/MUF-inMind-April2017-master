...
public class FestivalTimingSource extends TimingSource {
  ...
  public FestivalTimingSource(String clientHost, int clientPort, String festivalHost,int festivalPort) throws Exception {
			this.myHost=clientHost;
			this.myPort=clientPort;
			this.TTSHost=festivalHost;
			this.TTSPort=festivalPort;
			System.out.print("[FestivalTimingSource] Connecting to Festival at "+TTSHost+":"+TTSPort+"...");
			try {
					socket = new Socket(TTSHost,TTSPort); // connect to festival
					out = socket.getOutputStream();
					System.out.println("success!");
					System.out.print("[FestivalTimingSource] ");
					COM=new KQMLCommunication ("GBOX", 
																		 new String[]{"GBOX",myHost+":"+myPort});  
			} catch(IOException e) {
