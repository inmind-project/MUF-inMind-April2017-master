<!--  
   ...
   BeatGenerator.xsl
     - XSL-based beat generator for the BEATSimple gesture toolkit
...
<!-- Create a BEATSimple for each NEW item within a RHEME. -->
<xsl:template match="RHEME//NEW" priority="1">
<GESTURE_RIGHT TYPE="BEAT" PRIORITY="1">
   <xsl:copy>
