...
<!-- Create EYEBROWS for an OBJECT within a RHEME that has at least one NEW object within it. -->
<xsl:template match="RHEME//OBJECT[descendant::NEW]" priority="10">
<EYEBROWS>
   <xsl:copy>
