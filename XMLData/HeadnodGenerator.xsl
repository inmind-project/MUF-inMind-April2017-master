...
<!-- Create a BEATSimple for an OBJECT within a RHEME that has at least one NEW object within it. -->
<xsl:template match="RHEME//NEW" priority="20">
<HEADNOD>
   <xsl:copy>
