...
package edu.cmu.inmind.multiuser.rapportestimator.vhmsg;
...
public class VHMsg implements javax.jms.MessageListener
{
    ...
    private LinkedList<edu.usc.ict.vhmsg.MessageEvent> m_messages = new LinkedList<edu.usc.ict.vhmsg.MessageEvent>();
    ...
    public boolean sendMessage( Map<String,?> inArgs )
    {
        try
        {
            ...
            for ( Entry<String,?> me : inArgs.entrySet() )
            {
    ...
    public int poll()
    {
        ...
        if ( !m_immediateMethod )
        {
            for ( ;; )
            {
                edu.usc.ict.vhmsg.MessageEvent event;
    ...
    public void onMessage( Message msg )
    {
        ...
        try
        {
            ...
            if ( msg instanceof TextMessage )
            {
                ...
                edu.usc.ict.vhmsg.MessageEvent event = new edu.usc.ict.vhmsg.MessageEvent( this, message, eventMap );
