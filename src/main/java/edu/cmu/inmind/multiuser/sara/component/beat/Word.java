...
public class Word {
    ...
    float start_time;
    float end_time;
    List<edu.cmu.inmind.multiuser.sara.component.beat.bson.Viseme> visemes;
    ...
    public List<edu.cmu.inmind.multiuser.sara.component.beat.bson.Viseme> getVisemes() {
        return visemes;
    }

    public void setVisemes(List<edu.cmu.inmind.multiuser.sara.component.beat.bson.Viseme> visemes) {
