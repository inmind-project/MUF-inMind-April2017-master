 ...
 * your remote service:
 *
 * 1) explicitly by calling sendAndReceive method anywhere in your PlugableComponent code
 ...
 *
 * 1) Run SaraProject
 * 2) Run DialogueSystem: look at MainClass and uncomment the corresponding lines for this
 * example
 * 3) Run Android Client
 */
public class Ex08_RemoteService extends MainClass {
